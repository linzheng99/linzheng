...
export default function PortableTextBlockH4({ value, children }: PortableTextComponentProps<PortableTextBlock>) {
  return (
    <h4
      id={value._key}
      className="text-xl py-3 font-bold relative after:content-['_#'] after:opacity-0 hover:after:opacity-100 after:transition-opacity after:will-change-[opacity] after:pointer-events-none after:inline after:select-none text-gray-50">
